...
def m1():
    ...
    actor.drive_for(speed=3, angle=actor.lane_center, speed_distance=6)
...
def m3():
    ...
    actor.drive_for(speed=3.0, angle=0.0, speed_distance=1.0)
    ...
    # Pedestrian
    actor.drive_for(
        speed=3, angle=actor.lane_center, end_function=actor.lidar_3d, end_function_kwargs={"max_distance": 5.0}
    )
...
def m6():
    ...
    actor.drive_for(speed=3, angle=0, speed_distance=1)
    # actor.drive_for(speed=3, angle=-15, speed_distance=2)
